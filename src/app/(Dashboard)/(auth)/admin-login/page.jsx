        ...
        <div className="bg-white py-8 px-4 shadow-lg rounded-lg border border-gray-200">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#006198] hover:bg-[#004d7a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#006198] transition-colors"
              >
                Sign in
              </button>
            </div>
